//this javascript file is used as a directory for all of the images in the asset folder
//import the location of each image with a given name an export default
